    ...
    if(isset($_FILES['imagem']))
      {
        ...
        move_uploaded_file($_FILES['imagem']['tmp_name'],$produto->imagemDiretorio());
      }
  ...
  <section class="container-form">
    <form method="POST" enctype="multipart/form-data">
      ...
      <div class="container-radio">
        <div>
            <label for="cafe">Café</label>                         <!--   Esse getTipo é igual a Café? se for ele check se não for fica vazio -->
